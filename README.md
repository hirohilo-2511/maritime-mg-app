...
### 1ターン（1年）の流れ
1. **マーケティング予算の配分を確定する**（必須）。資金が足りない場合は「投資を見送る」で $0 のまま確定できます。**一度確定すると、その年の配分は変更できません。** 訴求ラインに届く施策がひとつもない配分では、確定前に警告が出ます。
2. **船主の要求に提案する、または辞退する**（任意）。裏付けのない要求は「今期は辞退する」で見送れます。
