...
### 倒産
決算後に資金がマイナスになると、その年で倒産としてゲームが終了し、評価は **D** になります。

### 評価
- **S**：信頼度 95 以上・最終資金が初期資金比 130% 以上・**第1優先的中率 80% 以上**
...
- 同梱の PDF マニュアル（`maritime_mg_manual_v3.pdf` など）は、上記の受注判定・倒産・未回答ペナルティの変更前の内容です。
